...
ENTRYPOINT ["java", "-Dotel.exporter=jaeger", "-Dotel.exporter.jaeger.endpoint=http://jaeger:14250", "-Dotel.exporter.jaeger.service.name=gateway", "-Dapplication.name=gateway", "-jar","/home/spring/app/bin/tp-app-form-1.2.0.jar"]
